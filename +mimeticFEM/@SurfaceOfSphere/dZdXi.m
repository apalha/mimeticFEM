function dZdXiEvaluated = dZdXi(obj,elements,xi,eta)
% dZdXi computes the dZdXi term of the metric for
% at the local positions (xi,eta) for the element. For the SurfaceOfSphere grid.
%
%   USAGE
%   -----
%       dZdXiEvaluated = obj.dZdXi(elements,xi,eta)
%
%   INPUTS
%   ------
...
%   OUTPUTS
%   -------
%       dZdXiEvaluated  :: the evaluation of the eta derivative of the mapping
...
%   Revisions:  2018-07-04 First implementation. (apalha)
    ...
    %% Compute dXdEta
    dZdXiEvaluated = dZ2dXiEvaluated .* dX1dXiEvaluated + dZ2dXiEvaluated .* dY1dXiEvaluated;
