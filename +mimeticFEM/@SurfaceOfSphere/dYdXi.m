function dYdXiEvaluated = dYdXi(obj,elements,xi,eta)
% dYdXi computes the dYdXi term of the metric for
% at the local positions (xi,eta) for the element. For the SurfaceOfSphere grid.
%
%   USAGE
%   -----
%       dYdXiEvaluated = obj.dYdXi(elements,xi,eta)
%
%   INPUTS
%   ------
...
%   OUTPUTS
%   -------
%       dYdXiEvaluated  :: the evaluation of the xi derivative of the mapping
...
%   Revisions:  2018-06-27 First implementation. (apalha)
    ...
    %% Compute dXdXi
    dYdXiEvaluated = dY2dXiEvaluated .* dX1dXiEvaluated + dY2dEtaEvaluated .* dY1dXiEvaluated;
