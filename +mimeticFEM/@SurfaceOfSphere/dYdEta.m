function dYdEtaEvaluated = dYdEta(obj,elements,xi,eta)
% dYdEta computes the dYdEta term of the metric for
% at the local positions (xi,eta) for the element. For the SurfaceOfSphere grid.
%
%   USAGE
%   -----
%       dYdEtaEvaluated = obj.dYdEta(elements,xi,eta)
%
%   INPUTS
%   ------
...
%   OUTPUTS
%   -------
%       dYdEtaEvaluated  :: the evaluation of the eta derivative of the mapping
...
%   Revisions:  2018-06-30 First implementation. (apalha)
    ...
    %% Compute dY2dXi: the derivative of the mapping from the subdomain to the surface of the sphere
    
    dY2dXiEvaluated = zeros(size(xi_subdomains));
    
    elementsToComputeIndex = 1:length(elements);
    
    % subdomain 1
    elementsInSubdomain_1 = elementsToComputeIndex(elementsSubDomain == 1);
    dY2dXiEvaluated(:, :, elementsInSubdomain_1) = -0.5 * (-xi_subdomains(:, :, elementsInSubdomain_1) +...
        (2/3)*xi_subdomains(:, :, elementsInSubdomain_1).*(eta_subdomains(:, :, elementsInSubdomain_1).^2)) ./...
        sqrt(1.0 - 0.5*(xi_subdomains(:, :, elementsInSubdomain_1).^2) - 0.5*(eta_subdomains(:, :, elementsInSubdomain_1).^2) +...
        (((xi_subdomains(:, :, elementsInSubdomain_1).*eta_subdomains(:, :, elementsInSubdomain_1)).^2)/3));
    
    % subdomain 2
    elementsInSubdomain_2 = elementsToComputeIndex(elementsSubDomain == 2);
    dY2dXiEvaluated(:, :, elementsInSubdomain_2) = sqrt(0.5 - (eta_subdomains(:, :, elementsInSubdomain_2).^2)/6);
    
    % subdomain 3
    elementsInSubdomain_3 = elementsToComputeIndex(elementsSubDomain == 3);
    dY2dXiEvaluated(:, :, elementsInSubdomain_3) = 0.5 * (-xi_subdomains(:, :, elementsInSubdomain_3) +...
        (2/3)*xi_subdomains(:, :, elementsInSubdomain_3).*(eta_subdomains(:, :, elementsInSubdomain_3).^2)) ./...
        sqrt(1.0 - 0.5*(xi_subdomains(:, :, elementsInSubdomain_3).^2) - 0.5*(eta_subdomains(:, :, elementsInSubdomain_3).^2) +...
        (((xi_subdomains(:, :, elementsInSubdomain_3).*eta_subdomains(:, :, elementsInSubdomain_3)).^2)/3));
    
    % subdomain 4
    elementsInSubdomain_4 = elementsToComputeIndex(elementsSubDomain == 4);
    dY2dXiEvaluated(:, :, elementsInSubdomain_4) = sqrt(0.5 - (eta_subdomains(:, :, elementsInSubdomain_4).^2)/6);
    
    % subdomain 5
    elementsInSubdomain_5 = elementsToComputeIndex(elementsSubDomain == 5);
    dY2dXiEvaluated(:, :, elementsInSubdomain_5) = -(1/6)*eta_subdomains(:, :, elementsInSubdomain_5).*xi_subdomains(:, :, elementsInSubdomain_5)./...
        sqrt(0.5 - (xi_subdomains(:, :, elementsInSubdomain_5).^2)/6);
    
    % subdomain 6
    elementsInSubdomain_6 = elementsToComputeIndex(elementsSubDomain == 6);
    dY2dXiEvaluated(:, :, elementsInSubdomain_6) = -(1/6)*eta_subdomains(:, :, elementsInSubdomain_6).*xi_subdomains(:, :, elementsInSubdomain_6)./...
        sqrt(0.5 - (xi_subdomains(:, :, elementsInSubdomain_6).^2)/6);
    
    
    %% Compute dY2dEta: the derivative of the mapping from the subdomain to the surface of the sphere
    
    dY2dEtaEvaluated = zeros(size(xi_subdomains));
    
    elementsToComputeIndex = 1:length(elements);
    
    % subdomain 1
    elementsInSubdomain_1 = elementsToComputeIndex(elementsSubDomain == 1);
    dY2dEtaEvaluated(:, :, elementsInSubdomain_1) = -0.5 * (-eta_subdomains(:, :, elementsInSubdomain_1) +...
        (2/3)*eta_subdomains(:, :, elementsInSubdomain_1).*(xi_subdomains(:, :, elementsInSubdomain_1).^2)) ./...
        sqrt(1.0 - 0.5*(xi_subdomains(:, :, elementsInSubdomain_1).^2) - 0.5*(eta_subdomains(:, :, elementsInSubdomain_1).^2) +...
        (((xi_subdomains(:, :, elementsInSubdomain_1).*eta_subdomains(:, :, elementsInSubdomain_1)).^2)/3));
    
    % subdomain 2
    elementsInSubdomain_2 = elementsToComputeIndex(elementsSubDomain == 2);
    dY2dEtaEvaluated(:, :, elementsInSubdomain_2) = -(1/6)*eta_subdomains(:, :, elementsInSubdomain_2).*xi_subdomains(:, :, elementsInSubdomain_2)./...
        sqrt(0.5 - (eta_subdomains(:, :, elementsInSubdomain_2).^2)/6);
    
    % subdomain 3
    elementsInSubdomain_3 = elementsToComputeIndex(elementsSubDomain == 3);
    dY2dEtaEvaluated(:, :, elementsInSubdomain_3) = 0.5 * (-eta_subdomains(:, :, elementsInSubdomain_3) +...
        (2/3)*eta_subdomains(:, :, elementsInSubdomain_3).*(xi_subdomains(:, :, elementsInSubdomain_3).^2)) ./...
        sqrt(1.0 - 0.5*(xi_subdomains(:, :, elementsInSubdomain_3).^2) - 0.5*(eta_subdomains(:, :, elementsInSubdomain_3).^2) +...
        (((xi_subdomains(:, :, elementsInSubdomain_3).*eta_subdomains(:, :, elementsInSubdomain_3)).^2)/3));
    
    % subdomain 4
    elementsInSubdomain_4 = elementsToComputeIndex(elementsSubDomain == 4);
    dY2dEtaEvaluated(:, :, elementsInSubdomain_4) = -(1/6)*eta_subdomains(:, :, elementsInSubdomain_4).*xi_subdomains(:, :, elementsInSubdomain_4)./...
        sqrt(0.5 - (eta_subdomains(:, :, elementsInSubdomain_4).^2)/6);
    
    % subdomain 5
    elementsInSubdomain_5 = elementsToComputeIndex(elementsSubDomain == 5);
    dY2dEtaEvaluated(:, :, elementsInSubdomain_5) = sqrt(0.5 - (xi_subdomains(:, :, elementsInSubdomain_5).^2)/6);
    
    % subdomain 6
    elementsInSubdomain_6 = elementsToComputeIndex(elementsSubDomain == 6);
    dY2dEtaEvaluated(:, :, elementsInSubdomain_6) = sqrt(0.5 - (xi_subdomains(:, :, elementsInSubdomain_6).^2)/6);
    ...
    %% Compute dXdEta
    dYdEtaEvaluated = dY2dXiEvaluated .* dX1dEtaEvaluated + dY2dEtaEvaluated .* dY1dEtaEvaluated;
