function g11Evaluated = g11(obj,element,xi,eta)
% g11 computes the g11 term of the metric at the local positions
%   (xi,eta) for the element. For the SurfaceOfSphere grid.
%
%   USAGE
%   -----
%       g11Evaluated = obj.g11(element,xi,eta)
%
%   INPUTS
%   ------
...
%   Revisions:  2018-07-04 (apalha) First implementation.
    ...
    g11Evaluated = (obj.dXdEta(element,xi,eta).*...
                    obj.dXdEta(element,xi,eta) +...
                    obj.dYdEta(element,xi,eta).*...
                    obj.dYdEta(element,xi,eta) +...
                    obj.dZdEta(element,xi,eta).*...
                    obj.dZdEta(element,xi,eta))./...
