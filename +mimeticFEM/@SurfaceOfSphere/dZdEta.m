function dZdEtaEvaluated = dZdEta(obj,elements,xi,eta)
% dZdEta computes the dZdEta term of the metric for
% at the local positions (xi,eta) for the element. For the SurfaceOfSphere grid.
%
%   USAGE
%   -----
%       dZdEtaEvaluated = obj.dZdEta(elements,xi,eta)
%
%   INPUTS
%   ------
...
%   OUTPUTS
%   -------
%       dZdEtaEvaluated  :: the evaluation of the eta derivative of the mapping
...
%   Revisions:  2018-07-04 First implementation. (apalha)
    ...
    dZ2dXiEvaluated = zeros(size(xi_subdomains));
    
    elementsToComputeIndex = 1:length(elements);
    
    % subdomain 1
    elementsInSubdomain_1 = elementsToComputeIndex(elementsSubDomain == 1);
    dZ2dXiEvaluated(:, :, elementsInSubdomain_1) = -(1/6)*eta_subdomains(:, :, elementsInSubdomain_1).*xi_subdomains(:, :, elementsInSubdomain_1)./...
        sqrt(0.5 - (xi_subdomains(:, :, elementsInSubdomain_1).^2)/6);
    
    % subdomain 2
    elementsInSubdomain_2 = elementsToComputeIndex(elementsSubDomain == 2);
    dZ2dXiEvaluated(:, :, elementsInSubdomain_2) = -(1/6)*eta_subdomains(:, :, elementsInSubdomain_2).*xi_subdomains(:, :, elementsInSubdomain_2)./...
        sqrt(0.5 - (xi_subdomains(:, :, elementsInSubdomain_2).^2)/6);
    
    % subdomain 3
    elementsInSubdomain_3 = elementsToComputeIndex(elementsSubDomain == 3);
    dZ2dXiEvaluated(:, :, elementsInSubdomain_3) = sqrt(0.5 - (eta_subdomains(:, :, elementsInSubdomain_3).^2)/6);
    
    % subdomain 4
    elementsInSubdomain_4 = elementsToComputeIndex(elementsSubDomain == 4);
    dZ2dXiEvaluated(:, :, elementsInSubdomain_4) = -0.5 * (-xi_subdomains(:, :, elementsInSubdomain_4) +...
        (2/3)*xi_subdomains(:, :, elementsInSubdomain_4).*(eta_subdomains(:, :, elementsInSubdomain_4).^2)) ./...
        sqrt(1.0 - 0.5*(xi_subdomains(:, :, elementsInSubdomain_4).^2) - 0.5*(eta_subdomains(:, :, elementsInSubdomain_4).^2) +...
        (((xi_subdomains(:, :, elementsInSubdomain_4).*eta_subdomains(:, :, elementsInSubdomain_4)).^2)/3));
    
    % subdomain 5
    elementsInSubdomain_5 = elementsToComputeIndex(elementsSubDomain == 5);
    dZ2dXiEvaluated(:, :, elementsInSubdomain_5) = 0.5 * (-xi_subdomains(:, :, elementsInSubdomain_5) +...
        (2/3)*xi_subdomains(:, :, elementsInSubdomain_5).*(eta_subdomains(:, :, elementsInSubdomain_5).^2)) ./...
        sqrt(1.0 - 0.5*(xi_subdomains(:, :, elementsInSubdomain_5).^2) - 0.5*(eta_subdomains(:, :, elementsInSubdomain_5).^2) +...
        (((xi_subdomains(:, :, elementsInSubdomain_5).*eta_subdomains(:, :, elementsInSubdomain_5)).^2)/3));
    
    % subdomain 6
    elementsInSubdomain_6 = elementsToComputeIndex(elementsSubDomain == 6);
    dZ2dXiEvaluated(:, :, elementsInSubdomain_6) = sqrt(0.5 - (eta_subdomains(:, :, elementsInSubdomain_6).^2)/6);
    
    
    %% Compute dX2dEta: the derivative of the mapping from the subdomain to the surface of the sphere
    
    dZ2dEtaEvaluated = zeros(size(xi_subdomains));
    
    elementsToComputeIndex = 1:length(elements);
    
    % subdomain 1
    elementsInSubdomain_1 = elementsToComputeIndex(elementsSubDomain == 1);
    dZ2dEtaEvaluated(:, :, elementsInSubdomain_1) = sqrt(0.5 - (xi_subdomains(:, :, elementsInSubdomain_1).^2)/6);
    
    % subdomain 2
    elementsInSubdomain_2 = elementsToComputeIndex(elementsSubDomain == 2);
    dZ2dEtaEvaluated(:, :, elementsInSubdomain_2) = sqrt(0.5 - (xi_subdomains(:, :, elementsInSubdomain_2).^2)/6);
    
    % subdomain 3
    elementsInSubdomain_3 = elementsToComputeIndex(elementsSubDomain == 3);
    dZ2dEtaEvaluated(:, :, elementsInSubdomain_3) = -(1/6)*eta_subdomains(:, :, elementsInSubdomain_3).*xi_subdomains(:, :, elementsInSubdomain_3)./...
        sqrt(0.5 - (eta_subdomains(:, :, elementsInSubdomain_3).^2)/6);
    
    % subdomain 4
    elementsInSubdomain_4 = elementsToComputeIndex(elementsSubDomain == 4);
    dZ2dEtaEvaluated(:, :, elementsInSubdomain_4) = -0.5 * (-eta_subdomains(:, :, elementsInSubdomain_4) +...
        (2/3)*eta_subdomains(:, :, elementsInSubdomain_4).*(xi_subdomains(:, :, elementsInSubdomain_4).^2)) ./...
        sqrt(1.0 - 0.5*(xi_subdomains(:, :, elementsInSubdomain_4).^2) - 0.5*(eta_subdomains(:, :, elementsInSubdomain_4).^2) +...
        (((xi_subdomains(:, :, elementsInSubdomain_4).*eta_subdomains(:, :, elementsInSubdomain_4)).^2)/3));
    
    % subdomain 5
    elementsInSubdomain_5 = elementsToComputeIndex(elementsSubDomain == 5);
    dZ2dEtaEvaluated(:, :, elementsInSubdomain_5) = 0.5 * (-eta_subdomains(:, :, elementsInSubdomain_5) +...
        (2/3)*eta_subdomains(:, :, elementsInSubdomain_5).*(xi_subdomains(:, :, elementsInSubdomain_5).^2)) ./...
        sqrt(1.0 - 0.5*(xi_subdomains(:, :, elementsInSubdomain_5).^2) - 0.5*(eta_subdomains(:, :, elementsInSubdomain_5).^2) +...
        (((xi_subdomains(:, :, elementsInSubdomain_5).*eta_subdomains(:, :, elementsInSubdomain_5)).^2)/3));
    
    % subdomain 6
    elementsInSubdomain_6 = elementsToComputeIndex(elementsSubDomain == 6);
    dZ2dEtaEvaluated(:, :, elementsInSubdomain_6) = -(1/6)*eta_subdomains(:, :, elementsInSubdomain_6).*xi_subdomains(:, :, elementsInSubdomain_6)./...
        sqrt(0.5 - (eta_subdomains(:, :, elementsInSubdomain_6).^2)/6);
    ...
    %% Compute dXdEta
    dZdEtaEvaluated = dZ2dXiEvaluated .* dX1dEtaEvaluated + dZ2dEtaEvaluated .* dY1dEtaEvaluated;
