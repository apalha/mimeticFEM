...
%   Revisions:  2015-08-05 (apalha) Updated documentation.
    ...
    g12Evaluated = (-mimeticFEM2.transfinite.dPhiYdEta(element,xi,eta,n,gamma,dgamma).*...
                     mimeticFEM2.transfinite.dPhiYdXi(element,xi,eta,n,gamma,dgamma)...
                    -mimeticFEM2.transfinite.dPhiXdEta(element,xi,eta,n,gamma,dgamma).*...
                     mimeticFEM2.transfinite.dPhiXdXi(element,xi,eta,n,gamma,dgamma))./...
