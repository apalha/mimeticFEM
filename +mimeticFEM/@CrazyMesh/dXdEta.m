...
%                           the points (xi,eta) of the elements.
...
%                          the same time, speeding up the computation. (apalha)
    ...
    dXdEtaEvaluated = pi*deltaY*0.5*obj.cc*...
