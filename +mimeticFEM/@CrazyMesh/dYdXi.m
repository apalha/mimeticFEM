function dYdXiEvaluated = dYdXi(obj,element,xi,eta)
% dYdXi computes the dXdEta term of the metric for
% at the local positions (xi,eta) for the element. For the crazy grid.
%
%   USAGE
%   -----
%       dYdXiEvaluated = obj.dYdXi(element,xi,eta)
%
%   INPUTS
%   ------
...
%                          the same time, speeding up the computation. (apalha)
    ...
    dYdXiEvaluated = pi*deltaX*0.5*obj.cc*...
