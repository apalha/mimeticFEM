function [epsilon_0] = HRotBasisPrimal(xi, eta, p, tensorGrid)
%HCurlBasisPrimal Returns (p+1)x(p+1) 2D basis of H1 primal space
%
%
% Computes the 2D HRot (H1) primal space basis functions by tensor product of 1D
...
%               2020-08-14 (apalha) Changed to HRotBasisPrimal for consistency
