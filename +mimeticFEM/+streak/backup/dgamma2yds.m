function dgamma2yds_evaluated = dgamma2yds(s,epsilon,kappa,delta)
% dgamma2yds computes the derivative of the y component of the right boundary
...
%   USAGE
%   -----
%       dgamma2yds_evaluated = dgamma2yds(s,epsilon,kappa,delta)
%
%
%   INPUTS
%   ------
...
%   Revisions:  2015-08-05 (apalha) First implementation.
    ...
    dgamma2yds_evaluated = epsilon*kappa*cos(s)*2.0*pi/4.0;
