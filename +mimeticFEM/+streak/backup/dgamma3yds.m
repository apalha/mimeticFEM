function dgamma3yds_evaluated = dgamma3yds(s,epsilon,kappa,delta)
% dgamma3yds computes the derivative of the y component of the top boundary
...
%   USAGE
%   -----
%       dgamma3yds_evaluated = dgamma3yds(s,epsilon,kappa,delta)
%
%
%   INPUTS
%   ------
...
%   Revisions:  2015-08-05 (apalha) First implementation.
    ...
    dgamma3yds_evaluated = epsilon*kappa*cos(s)*2.0*pi/4.0;
