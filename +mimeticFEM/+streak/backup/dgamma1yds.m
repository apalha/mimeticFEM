function dgamma1yds_evaluated = dgamma1yds(s,epsilon,kappa,delta)
% dgamma1yds computes the derivative of the y component of the bottom boundary
...
%   USAGE
%   -----
%       dgamma1yds_evaluated = dgamma1yds(s,epsilon,kappa,delta)
%
%
%   INPUTS
%   ------
