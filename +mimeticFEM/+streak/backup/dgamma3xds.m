function [dgamma3xds_evaluated,dgamma3yds_evaluated] = dgamma3ds(s,epsilon,kappa,delta)
...
%   USAGE
%   -----
%       [dgamma3xds_evaluated,dgamma3yds_evaluated] = dgamma3ds(s,epsilon,kappa,delta)
%
%
%   INPUTS
%   ------
...
%   Revisions:  2015-08-05 (apalha) First implementation.
    ...
    dgamma3xds_evaluated = epsilon.*(1.0+alpha*cos(s)).*sin(s+alpha.*sin(s)).*(2.0*pi/4.0);
