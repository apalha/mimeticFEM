function dPhiXdXiEvaluated = dPhiXdXi(element,xi,eta,n)
...
%   USAGE
%   -----
%       dPhiXdXiEvaluated = dPhiXdXi(element,xi,eta,n,region)
%
%   INPUTS
%   ------
...
%   Revisions:  2015-08-05 (apalha) Updated documentation.
    ...
    sizeNodes = size(xi);
    dPhiXdXiEvaluated = zeros(sizeNodes(1),sizeNodes(2),length(element));
    ...
    for k=1:length(element)
        ...
        dPhiXdXiEvaluated(:,:,k) = mimeticFEM2.transfinite.dPhiXdXi(element_region,xi,eta,n,gamma,dgamma);
    end
end