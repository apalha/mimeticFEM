function dPhiYdXiEvaluated = dPhiYdXi(element,xi,eta,n)
...
%   USAGE
%   -----
%       dPhiYdXiEvaluated = dPhiYdXi(element,xi,eta,n,region)
%
%   INPUTS
%   ------
...
%   Revisions:  2015-08-05 (apalha) Updated documentation.
    ...
    sizeNodes = size(xi);
    dPhiYdXiEvaluated = zeros(sizeNodes(1),sizeNodes(2),length(element));
    ...
    for k=1:length(element)
        ...
        dPhiYdXiEvaluated(:,:,k) = mimeticFEM2.transfinite.dPhiYdXi(element_region,xi,eta,n,gamma,dgamma);
    end
end