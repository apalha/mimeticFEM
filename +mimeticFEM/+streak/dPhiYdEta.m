function dPhiYdEtaEvaluated = dPhiYdEta(element,xi,eta,n)
...
%   USAGE
%   -----
%       dPhiYdEtaEvaluated = dPhiYdEta(element,xi,eta,n,region)
%
%   INPUTS
%   ------
...
%   Revisions:  2015-08-05 (apalha) Updated documentation.
    ...
    sizeNodes = size(xi);
    dPhiYdEtaEvaluated = zeros(sizeNodes(1),sizeNodes(2),length(element));
    ...
    for k=1:length(element)
        ...
        dPhiYdEtaEvaluated(:,:,k) = mimeticFEM2.transfinite.dPhiYdEta(element_region,xi,eta,n,gamma,dgamma);
    end
end