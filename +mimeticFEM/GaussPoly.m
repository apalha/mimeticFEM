...
%             -                                               -
% If x=[] then it computes the Gauss polynomial basis at the Gauss nodes,
% that is, the result is a sparse identity matrix.
%
%   USAGE
%   -----
%       result = GaussPoly(x,p)
%
%       Gives the p+1 Gauss basis interpolants evaluated at x.
%
%   INPUTS
%   ------
...
%               2014-12-03 (apalha) Added fast for loop (2x speedup).
